...
namespace Svg.Model {
    ...
    public static partial class SvgExtensions {
        internal static float ToDeviceValue(this SvgUnit svgUnit, UnitRenderingType renderType, SvgElement? owner,
            SKRect skBounds) {
                ...
                case SvgUnitType.Percentage:
                    ...
                    switch (renderType) {
                        ...
                        case UnitRenderingType.Other:
                            if (owner?.OwnerDocument?.ViewBox is { } && owner.OwnerDocument.ViewBox.Width != 0 &&
        ...
        internal static void GetOptionalNumbers(this SvgNumberCollection? svgNumberCollection, float defaultValue1,
            float defaultValue2, out float value1, out float value2) {
        ...
        internal static float CalculateOtherPercentageValue(this SKRect skBounds) {
            return (float)(Math.Sqrt(skBounds.Width * skBounds.Width + skBounds.Width * skBounds.Height) /
                           Math.Sqrt(2.0));
        }
            ...
            foreach (var svgTransform in svgTransformCollection) {
                switch (svgTransform) {
                    ...
                    case SvgRotate svgRotate: {
                        var skMatrixRotate =
                            SKMatrix.CreateRotationDegrees(svgRotate.Angle, svgRotate.CenterX, svgRotate.CenterY);
        ...
        internal static SKMatrix ToMatrix(this SvgViewBox svgViewBox, SvgAspectRatio? svgAspectRatio, float x, float y,
        ...
        internal static SKRect? CalculateRect(SvgUnit xUnit, SvgUnit yUnit, SvgUnit widthUnit, SvgUnit heightUnit,
            SvgCoordinateUnits coordinateUnits, SKRect skBounds, SKRect skViewport, SvgElement? svgElement) {
            ...
            var width = widthUnit.ToDeviceValue(UnitRenderingType.Horizontal, svgElement,
                useBoundingBox ? skBounds : skViewport);
            var height = heightUnit.ToDeviceValue(UnitRenderingType.Vertical, svgElement,
                useBoundingBox ? skBounds : skViewport);
