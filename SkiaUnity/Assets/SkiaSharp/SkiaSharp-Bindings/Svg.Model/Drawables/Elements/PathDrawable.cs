...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class PathDrawable : DrawablePath {
        ...
        public static PathDrawable Create(SvgPath svgPath, SKRect skViewport, DrawableBase? parent,
            ...
            drawable.IsDrawable = drawable.CanDraw(svgPath, drawable.IgnoreAttributes) &&
                                  drawable.HasFeatures(svgPath, drawable.IgnoreAttributes);
        ...
        private void Initialize(SKRect skViewport, HashSet<Uri>? references) {
            ...
            if (SvgExtensions.IsValidStroke(svgPath, GeometryBounds)) {
                Stroke = SvgExtensions.GetStrokePaint(svgPath, GeometryBounds, AssetLoader, references,
                    IgnoreAttributes);
                if (Stroke is null) {
                    canDrawStroke = false;
                }
