...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class LineDrawable : DrawablePath {
        ...
        public static LineDrawable Create(SvgLine svgLine, SKRect skViewport, DrawableBase? parent,
            ...
            drawable.IsDrawable = drawable.CanDraw(svgLine, drawable.IgnoreAttributes) &&
                                  drawable.HasFeatures(svgLine, drawable.IgnoreAttributes);
        ...
        private void Initialize(SKRect skViewport, HashSet<Uri>? references) {
            ...
            if (SvgExtensions.IsValidStroke(svgLine, GeometryBounds)) {
                Stroke = SvgExtensions.GetStrokePaint(svgLine, GeometryBounds, AssetLoader, references,
                    IgnoreAttributes);
                if (Stroke is null) {
                    canDrawStroke = false;
                }
