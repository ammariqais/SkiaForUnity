...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class MaskDrawable : DrawableContainer {
        ...
        public static MaskDrawable Create(SvgMask svgMask, SKRect skViewport, DrawableBase? parent,
            ...
            var skRectTransformed = SvgExtensions.CalculateRect(xUnit, yUnit, widthUnit, heightUnit, maskUnits,
                skViewport, skViewport, svgMask);
