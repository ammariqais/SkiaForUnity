...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class SwitchDrawable : DrawableBase {
        ...
        public static SwitchDrawable Create(SvgSwitch svgSwitch, SKRect skViewport, DrawableBase? parent,
            ...
            drawable.IsDrawable = drawable.CanDraw(svgSwitch, drawable.IgnoreAttributes) &&
                                  drawable.HasFeatures(svgSwitch, drawable.IgnoreAttributes);
            ...
            foreach (var child in svgSwitch.Children) {
                ...
                if (hasRequiredFeatures && hasRequiredExtensions && hasSystemLanguage) {
                    var childDrawable = DrawableFactory.Create(child, skViewport, parent, assetLoader, references,
                        ignoreAttributes);
                    if (childDrawable is { }) {
