...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class CircleDrawable : DrawablePath {
        ...
        public static CircleDrawable Create(SvgCircle svgCircle, SKRect skViewport, DrawableBase? parent,
            ...
            drawable.IsDrawable = drawable.CanDraw(svgCircle, drawable.IgnoreAttributes) &&
                                  drawable.HasFeatures(svgCircle, drawable.IgnoreAttributes);
        ...
        private void Initialize(HashSet<Uri>? references) {
            ...
            if (SvgExtensions.IsValidStroke(svgCircle, GeometryBounds)) {
                Stroke = SvgExtensions.GetStrokePaint(svgCircle, GeometryBounds, AssetLoader, references,
                    IgnoreAttributes);
                if (Stroke is null) {
                    canDrawStroke = false;
                }
