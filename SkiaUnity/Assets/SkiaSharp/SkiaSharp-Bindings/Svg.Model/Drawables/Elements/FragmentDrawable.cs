...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class FragmentDrawable : DrawableContainer {
        ...
        public static FragmentDrawable Create(SvgFragment svgFragment, SKRect skViewport, DrawableBase? parent,
            ...
            var x = svgFragmentParent is null
                ? 0f
                : svgFragment.X.ToDeviceValue(UnitRenderingType.Horizontal, svgFragment, skViewport);
            var y = svgFragmentParent is null
                ? 0f
                : svgFragment.Y.ToDeviceValue(UnitRenderingType.Vertical, svgFragment, skViewport);
        ...
        private void Initialize(SKRect skViewport, float x, float y, SKSize skSize) {
            ...
            var skViewBoxMatrix = SvgExtensions.ToMatrix(svgFragment.ViewBox, svgFragment.AspectRatio, x, y,
            ...
            if (svgClipPath?.Children is { }) {
                ...
                if (clipPath.Clips is { } && clipPath.Clips.Count > 0 &&
                    !IgnoreAttributes.HasFlag(DrawAttributes.ClipPath)) {
                    ClipPath = clipPath;
                } else {
                    ClipPath = null;
                }
