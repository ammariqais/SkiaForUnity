...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class GroupDrawable : DrawableContainer {
        ...
        public static GroupDrawable Create(SvgGroup svgGroup, SKRect skViewport, DrawableBase? parent,
            ...
            drawable.IsDrawable = drawable.CanDraw(svgGroup, drawable.IgnoreAttributes) &&
                                  drawable.HasFeatures(svgGroup, drawable.IgnoreAttributes);
        ...
        private void Initialize(HashSet<Uri>? references) {
            ...
            if (SvgExtensions.IsValidStroke(svgGroup, GeometryBounds)) {
                Stroke = SvgExtensions.GetStrokePaint(svgGroup, GeometryBounds, AssetLoader, references,
                    IgnoreAttributes);
            }
        }
    }
