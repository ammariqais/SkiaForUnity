...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class ImageDrawable : DrawableBase {
        ...
        public static ImageDrawable Create(SvgImage svgImage, SKRect skViewport, DrawableBase? parent,
            ...
            drawable.IsDrawable = drawable.CanDraw(svgImage, drawable.IgnoreAttributes) &&
                                  drawable.HasFeatures(svgImage, drawable.IgnoreAttributes);
            ...
            if (svgFragment is { }) {
                drawable.FragmentDrawable = FragmentDrawable.Create(svgFragment, skViewport, drawable, assetLoader,
