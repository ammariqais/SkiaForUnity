...
namespace Svg.Model.Drawables.Elements {
    ...
    public sealed class MarkerDrawable : DrawableBase {
        ...
        public static MarkerDrawable Create(SvgMarker svgMarker, SvgVisualElement pOwner, SKPoint pMarkerPoint,
            float fAngle, SKRect skViewport, DrawableBase? parent, IAssetLoader assetLoader, HashSet<Uri>? references,
            ...
            var skMatrixAngle =
                SKMatrix.CreateRotationDegrees(svgMarker.Orient.IsAuto ? fAngle : svgMarker.Orient.Angle);
            ...
            switch (svgMarker.MarkerUnits) {
                case SvgMarkerUnits.StrokeWidth: {
                    ...
                    var skMatrixTranslateRefXY = SKMatrix.CreateTranslation(-refX * viewBoxToMarkerUnitsScaleX,
                        -refY * viewBoxToMarkerUnitsScaleY);
            ...
            var markerElementDrawable = DrawableFactory.Create(markerElement, skViewport, drawable, assetLoader,
                references, DrawAttributes.Display);
