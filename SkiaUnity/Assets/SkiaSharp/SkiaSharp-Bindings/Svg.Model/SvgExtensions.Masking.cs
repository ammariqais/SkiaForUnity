...
namespace Svg.Model {
    ...
    public static partial class SvgExtensions {
        ...
        internal static void GetClipPath(SvgVisualElement svgVisualElement, SKRect skBounds, HashSet<Uri> uris,
            ClipPath? clipPath, SvgClipRule? svgClipPathClipRule) {
            if (clipPath is null) {
                return;
            }
        ...
        private static void GetClipPath(SvgElementCollection svgElementCollection, SKRect skBounds, HashSet<Uri> uris,
            ClipPath? clipPath, SvgClipRule? svgClipPathClipRule) {
        ...
        internal static void GetClipPathClipPath(SvgClipPath svgClipPath, SKRect skBounds, HashSet<Uri> uris,
            ClipPath? clipPath) {
            if (clipPath is null) {
                return;
            }
        ...
        internal static void GetClipPath(SvgClipPath svgClipPath, SKRect skBounds, HashSet<Uri> uris,
            ClipPath? clipPath) {
            if (clipPath is null) {
                return;
            }
        ...
        internal static void GetSvgVisualElementClipPath(SvgVisualElement? svgVisualElement, SKRect skBounds,
            HashSet<Uri> uris, ClipPath clipPath) {
        ...
        internal static MaskDrawable? GetSvgElementMask(SvgElement svgElement, SKRect skBounds, HashSet<Uri> uris,
            IAssetLoader assetLoader, HashSet<Uri>? references) {
