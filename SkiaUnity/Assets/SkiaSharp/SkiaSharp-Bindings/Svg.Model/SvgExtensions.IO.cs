...
namespace Svg.Model {
    ...
    public static partial class SvgExtensions {
        ...
        internal static object? GetImageFromDataUri(string? uriString, SvgDocument svgOwnerDocument,
            ...
            var headers = new List<string>(uriString.Substring(headerStartIndex, headerEndIndex - headerStartIndex)
                .Split(';'));
        ...
        public static SKDrawable? ToDrawable(SvgFragment svgFragment, IAssetLoader assetLoader,
            HashSet<Uri>? references, out SKRect? bounds, DrawAttributes ignoreAttributes = DrawAttributes.None) {
        ...
        public static SKPicture? ToModel(SvgFragment svgFragment, IAssetLoader assetLoader, out SKDrawable? skDrawable,
            out SKRect? skBounds, DrawAttributes ignoreAttributes = DrawAttributes.None) {
