...
namespace Svg.Model {
    ...
    public static partial class SvgExtensions {
        ...
        internal static System.Drawing.PointF ToAbsolute(System.Drawing.PointF point, bool isRelative,
            ...
            for (var i = 0; i < svgPathSegmentList.Count; i++) {
                ...
                switch (svgSegment) {
                    ...
                    case SvgCubicCurveSegment svgCubicCurveSegment: {
                        ...
                        if (float.IsNaN(firstControlPoint.X) || float.IsNaN(firstControlPoint.Y)) {
                            ...
                            if (prev >= 0 && svgPathSegmentList[prev] is SvgCubicCurveSegment) {
                                ...
                                firstControlPoint =
                                    Reflect(
                                        new System.Drawing.PointF(prevSecondControlPoint.X, prevSecondControlPoint.Y),
                                        start);
                            } else {
                        ...
                        var second = ToAbsolute(svgCubicCurveSegment.SecondControlPoint,
                            svgCubicCurveSegment.IsRelative, start);
                    ...
                    case SvgQuadraticCurveSegment svgQuadraticCurveSegment: {
                        ...
                        if (float.IsNaN(controlPoint.X) || float.IsNaN(controlPoint.Y)) {
                            ...
                            if (prev >= 0 && svgPathSegmentList[prev] is SvgQuadraticCurveSegment) {
                                ...
                                controlPoint =
                                    Reflect(new System.Drawing.PointF(prevControlPoint.X, prevControlPoint.Y), start);
                            } else {
                                controlPoint = start;
                            }
                        } else {
                    ...
                    case SvgArcSegment svgArcSegment: {
                        ...
                        var largeArc = svgArcSegment.Size == SvgArcSize.Small
                            ? SKPathArcSize.Small
                            : SKPathArcSize.Large;
                        var sweep = svgArcSegment.Sweep == SvgArcSweep.Negative
        ...
        internal static SKPath? ToPath(this SvgPointCollection svgPointCollection, SvgFillRule svgFillRule,
            bool isClosed, SKRect skViewport) {
            var fillType = svgFillRule == SvgFillRule.EvenOdd ? SKPathFillType.EvenOdd : SKPathFillType.Winding;
            var skPath = new SKPath {
                FillType = fillType
            };
