...
namespace ShimSkiaSharp {
    ...
    public record DrawImageCanvasCommand(SKImage? Image, SKRect Source, SKRect Dest, SKPaint? Paint = null)
        : CanvasCommand;
    ...
    public record DrawTextOnPathCanvasCommand(string Text, SKPath? Path, float HOffset, float VOffset, SKPaint? Paint)
        : CanvasCommand;
    ...
    public class SKCanvas {
        ...
        public void ClipPath(ClipPath clipPath, SKClipOperation operation = SKClipOperation.Intersect,
            bool antialias = false) {
            Commands?.Add(new ClipPathCanvasCommand(clipPath, operation, antialias));
        }

        public void ClipRect(SKRect rect, SKClipOperation operation = SKClipOperation.Intersect,
            bool antialias = false) {
