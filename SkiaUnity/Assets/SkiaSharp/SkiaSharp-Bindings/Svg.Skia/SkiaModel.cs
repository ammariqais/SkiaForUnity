...
public class SkiaModel
{
    ...
    public SkiaSharp.SKRect ToCropRect(SKImageFilter.CropRect? cropRect)
    {
        return cropRect is null ? new SkiaSharp.SKRect() : ToSKRect(cropRect.Rect);
    }
    ...
    public SkiaSharp.SKImageFilter? ToSKImageFilter(SKImageFilter? imageFilter)
    {
        switch (imageFilter)
        {
            ...
            case PaintImageFilter paintImageFilter:
            {
                ...
                return SkiaSharp.SKImageFilter.CreateShader(
                    null,
                    false);
            }
